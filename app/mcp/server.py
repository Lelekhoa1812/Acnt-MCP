...
MCP_SERVER_INSTRUCTIONS = (
    ...
    "family, category, region, or all inventory; it returns summed groups. Use product_intelligence_rank for "
    "complex hierarchy, dimension, pricing, attribute/style, state, and product image ranking. Use "
    "stock_rank_variants only when the user asks which variant or SKU ranks highest/lowest by stock alone. "
    "Use stock_detail for exact product/SKU detail and "
