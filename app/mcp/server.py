...
MCP_SERVER_INSTRUCTIONS = (
    ...
    "for the user to pick, or offer accounting_collective_create to create a new one. "
    "Before calling accounting_collective_create, call accounting_host_list to discover available fiscal "
    "host slugs — pass the chosen slug as host.slug in the create call. "
    ...
    "The snapshot shows open liabilities (pending/approved/draft expenses) even when collective balance "
    "is zero — a zero balance means no contributions have been received, not that there are no expenses. "
