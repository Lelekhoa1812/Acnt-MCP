...
MCP_SERVER_INSTRUCTIONS = (
    ...
    "for Harmonise image retrieval/rendering; if native image content is not visible, follow its rendering "
    "fallback order: browser HTML preview, desktop python3 local-file preview, then Markdown/link. Use stock_detail for exact product/SKU detail and stock_compare "
