...
MCP_SERVER_INSTRUCTIONS = (
    ...
    "live marketplace discovery; use opencollective_expense_list, opencollective_transaction_all, "
    "opencollective_expense_create, opencollective_expense_update, opencollective_expense_delete, "
    "opencollective_expense_process, and opencollective_budget_lookup for public finance transparency "
    "and accounting workflow automation; use openlibrary_book_search, openlibrary_isbn_lookup, and "
