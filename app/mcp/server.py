...
MCP_SERVER_INSTRUCTIONS = (
    ...
    "local download of the resolved URI, activated-environment python3 script preview, then best URI only with "
    "an AI client technical rendering issue explanation. Use stock_detail for exact product/SKU detail and stock_compare "
